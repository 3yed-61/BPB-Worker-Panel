...
// @ts-ignore
// https://github.com/3yed82/BPB-Worker-Panel
...
function generateRemark(index, port, address, cleanIPs, protocol, configType) {
    ...
    return `${index} - ${protocol}${type} - ${addressType} : ${port} |♨️`;
}
	...
	<body>
		...
		<div class="form-container">
            ...
            <div class="footer">
                ...
                <a class="link" href="https://github.com/3yed82/BPB-Worker-Panel" target="_blank">Github</a>
